...
// * Load ESM exports dynamically 
const loadImports = (async () => {
  const { appLocales, DEFAULT_LOCALE } = await import('../../app/i18n.mjs');
  return { appLocales, DEFAULT_LOCALE }
})();

// * Because we don't have top level await, I wrapped the whole code in .then()
loadImports.then(({ appLocales, DEFAULT_LOCALE }) => {
